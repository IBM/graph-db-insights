...
repository](https://github.com/IBM/graph-db-insights).

A good way to familiarize yourself with the codebase and contribution process is
to look for and tackle low-hanging fruit in the [issue
tracker](https://github.com/IBM/graph-db-insights/issues). Before embarking on
...
issue](https://github.com/IBM/graph-db-insights/issues) before sending a pull
